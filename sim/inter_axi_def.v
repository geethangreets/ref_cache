...
`ifdef BIT_DEPTH_12
   `ifdef DEF_CH_TYPE_422
      `define REF_PIX_BU_OFFSET (9'd256)
      `define REF_PIX_BU_OFFSET_SHIFT (4'd8)
      `define REF_PIX_BU_ROW_OFFSET (12'd2048)
      `define REF_PIX_BU_ROW_OFFSET_SHIFT (4'd11)
      `define REF_PIX_IU_OFFSET (16'd16384)
      `define REF_PIX_IU_OFFSET_SHIFT (4'd14)

      `define REF_PIX_IU_ROW_OFFSET (22'd1048576)
   ...
   `elsif DEF_CH_TYPE_444
      `define REF_PIX_BU_OFFSET (10'd512)
      `define REF_PIX_BU_OFFSET_SHIFT (4'd9)
      `define REF_PIX_BU_ROW_OFFSET (13'd4096)
      `define REF_PIX_BU_ROW_OFFSET_SHIFT (4'd12)
      `define REF_PIX_IU_OFFSET (16'd32768)
      `define REF_PIX_IU_OFFSET_SHIFT (5'd15)

      `define REF_PIX_IU_ROW_OFFSET (23'h20_0000)
...
`elsif BIT_DEPTH_10
   ...
   `else 
   // DEF_CH_TYPE_420
      `define REF_PIX_BU_OFFSET (9'd128)
      `define REF_PIX_BU_OFFSET_SHIFT (4'd7)
      `define REF_PIX_BU_ROW_OFFSET (12'd1024)
